...
import bg.sofia.uni.fmi.piss.project.wevip.service.CourseService;
...
public class CourseController {
    ...
    @PostMapping("/performers/{courseId}")
    public ResponseEntity geCoursePerformersById(@PathVariable String courseId) {
        return courseService.getCoursePerformersById(courseId);
    }
